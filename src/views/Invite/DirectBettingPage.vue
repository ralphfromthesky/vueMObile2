  ...
  <!-- <PageLayout title="Invite"> -->
    <div class="mainDiv w-screen">
      ...
      <div class="flex flex-col h-[calc(100vh-4.1rem)] p-[.2rem] overflow-auto">
            ...
            <div class="flex flex-col gap-[.1rem]">
              <div class="flex items-center gap-[.1rem]">
                <span class="flex items-center text-[#fff] text-[.2rem]">{{
                  bettingValue.promotionCode ? bettingValue.promotionCode : "-"
                }}</span>
                <span class="flex items-center text-[#fff] text-[.2rem]"
                  ><img
        ...
        <div
          v-if="BettingData?.content?.rows?.length == 0"
          ...
          <div class="flex flex-col gap-[.1rem] w-fit leading-none">
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center text-nowrap">
                <span class="text-[.2rem] text-white">Effective Bets</span>
              </div>
            </div>
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center text-nowrap">
                <span class="text-[.2rem] text-white"
                  >Other Effective Bets</span
                >
              </div>
            </div>
            <div class="flex gap-[.5rem] items-center">
          ...
          <div class="flex flex-col gap-[.1rem] leading-none">
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.directValidBetNum
                    ? BettingData?.content?.aggsData?.directValidBetNum
                    : 0
                }}</span>
              </div>
            ...
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.otherBetNum
                    ? BettingData?.content?.aggsData?.otherBetNum
                    : 0
                }}</span>
              </div>
            ...
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.allBetNum
                    ? BettingData?.content?.aggsData?.allBetNum
                    : 0
                }}</span>
              </div>
        ...
        <div class="flex gap-[.2rem]">
          <div class="flex flex-col gap-[.1rem] leading-none">
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center text-nowrap">
                <span class="text-[.2rem] text-white"
                  >Direct Subordinate Win/Win</span
                >
              </div>
            </div>
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center text-nowrap">
                <span class="text-[.2rem] text-white"
                  >Other subordinate's winnings</span
                >
              </div>
            </div>
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center text-nowrap">
                <span class="text-[.2rem] text-white">Total Win&Lose</span>
              </div>
            </div>
          </div>
          <div class="flex flex-col gap-[.1rem] leading-none">
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.directWinLostMoney
                    ? BettingData?.content?.aggsData?.directWinLostMoney
                    : 0
                }}</span>
              </div>
            ...
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.otherWinLostMoney
                    ? BettingData?.content?.aggsData?.otherWinLostMoney
                    : 0
                }}</span>
              </div>
            ...
            <div class="flex gap-[.5rem] items-center">
              <div class="flex items-center">
                <span class="text-[.2rem] text-white">{{
                  BettingData?.content?.aggsData?.allWinLostMoney
                    ? BettingData?.content?.aggsData?.allWinLostMoney
                    : 0
                }}</span>
              </div>
...
const Betting = useMutation({
  mutationFn: (payload) =>
    axiosPost2("api/native/v2/getDirectSubBets.do", payload),
  onSuccess: (data) => {

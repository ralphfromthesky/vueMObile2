  ...
  <div class="flex flex-col gap-[.2rem] p-[.2rem] w-full">
    <div class="flex bg-[#05309F] w-full rounded-[.1rem]">
      <div class="flex w-[2.5rem] justify-center items-baseline relative">
        ...
        <img
          src="/inviteImages/question.png"
          class="w-[.3rem] absolute right-[.1rem] top-[.02rem]"
          alt=""
        />
      </div>
      <div class="flex p-[.2rem] pl-0 gap-[.2rem] justify-between w-full">
        <div class="flex flex-col leading-[.31rem] gap-[.2rem]">
          <div class="flex flex-col">
            ...
            <div class="flex items-center gap-[.1rem]">
              <span class="text-white text-[.27rem]">{{
                store.state.userInfo.promCode
              }}</span>
          ...
          <div class="flex flex-col">
            <div class="flex items-center gap-[.1rem]">
              ...
              <span class="text-amber-500 text-[.27rem]">{{
                invitationData?.proxyId ? invitationData?.proxyId : "No"
              }}</span>
              <img
                v-if="invitationData?.proxyId"
        ...
        <div class="flex flex-col gap-[.1rem] leading-none items-end">
          <button
            class="w-[1.2rem] bg-[#FFF0BB] text-[#05309F] text-[.22rem] rounded-[.1rem] h-[.5rem]"
            @click="navigateTo('/mainNav')"
          >
            One Click
          </button>
          <button
            class="w-[1.2rem] bg-[#999] text-white text-[.22rem] rounded-[.1rem] h-[.5rem]"
          >
            Award List
          </button>
          <span class="text-[.28rem] text-[#FFAA09]">{{
            userData?.money ? userData?.money : "0.00"
          }}</span>
        </div>
      </div>
    </div>
                ...
                <div class="flex w-full">
                  ...
                  >
                    ...
                    <span class="text-[.24rem] text-[#A0C5FB] break-all"
                      >{{
                        store.state.inviteData?.data?.content?.prompInfo
                          ?.linkUrl
                          ? store.state.inviteData?.data?.content?.prompInfo
                              ?.linkUrl
                          : "No data for now"
    ...
    <div class="flex flex-col bg-[#05309F] w-full rounded-[.1rem]">
      ...
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-[#FFAA09] text-[.24rem]">{{
              invitationData?.newInfo?.rebatePrompActBonus
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-[#FFAA09] text-[.24rem]">{{
              invitationData?.newInfo?.todayRebatePrompActBonus
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-[#FFAA09] text-[.24rem]">{{
              invitationData?.newInfo?.lastBonus
            }}</span>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col bg-[#05309F] w-full rounded-[.1rem]">
        ...
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.teamRegCount
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.directSubRegCount
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.otherSubRegCount
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.totalBetBateMoney
            }}</span>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col bg-[#05309F] w-full rounded-[.1rem]">
      ...
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          <span class="text-[#6FA4EF] text-[.24rem]"
            >Total de apostas válidas</span
          >
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.totalBetMoney
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full border-b-[.01rem] border-b-[#3A61C2]">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-white text-[.24rem]">{{
              invitationData?.newInfo?.totalBetOrderNum
            }}</span>
          </div>
        </div>
      </div>
      <div class="flex w-full">
        <div class="flex justify-between p-[.2rem] w-full">
          ...
          <div class="flex gap-[.15rem] items-center">
            <span class="text-[#FF4A4A] text-[.24rem]">{{
              invitationData?.newInfo?.totalWinLost
            }}</span>
          </div>
        </div>
      </div>
...
const Invitation = useMutation({
  mutationFn: (payload) =>
    axiosGet2("api/native/v2/inviteOverview2.do", payload),
  onSuccess: (data) => {

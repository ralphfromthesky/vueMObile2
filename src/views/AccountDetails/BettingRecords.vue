    ...
    <div class="mainDiv w-screen h-auto bg-[#1A45B1] p-[.2rem]">
      <div class="w-fullflex p-[.2rem]">
        <div class="flex gap-[.2rem] justify-center">
          <Select :pass="sched" title="Today" widthSize="2rem" @selected-item="handleSelecteditem" />
          <Select :pass="names" @selected-Event="handleSelectedEvents" title="Chess" />

          <Select :pass="allBets" title="All Platform" @selected-Platform="selectedPlatform" />

        </div>
      </div>
      <div class="flex flex-col h-[calc(100vh-2.9rem)] overflow-auto gap-[.2rem]">
          ...
          <div class="grid grid-cols-2 gap-[.2rem]">
            ...
            <div class="flex flex-col gap-[.1rem]">
              ...
              <div class="flex gap-[.1rem]">
                ...
                <span class="text-[#fff] text-[.2rem]">{{ bettingValue.username }}-{{
              ...
              <div class="flex gap-[.1rem]">
                <span class="text-[#fff] text-[.2rem]">Amount won or lost:</span>
                <span class="text-[#fff] text-[.2rem]">{{
        ...
        <div v-if="bettingData?.content?.rows == 0" class="flex flex-col items-center h-full overflow-auto w-full/">

<template>
  <div>
    <div class="text-white relative">
      ...
      <div
        class="flex justify-center items-center gap-[.1rem] bg-bg rounded-[.1rem] my-[.1rem] h-[1rem]"
      >
        <div
...
const activeType = ref('Daily tasks')
const count = ref(4);

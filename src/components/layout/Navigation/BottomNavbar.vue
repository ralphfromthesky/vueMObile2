<template>
    <div :class="['btom flex items-center  w-full h-[1.32rem] fixed bottom-0 p-[.2rem]',
    store.state.setThemes.lightTheme ? 'bg-[#f08abd] text-[#ffffff]' : 'bg-[#032B92] text-[white]',
    store.state.setThemes.darkTheme ? 'bg-[#1d1c1c] text-white' : ' text-[white]'
]">
